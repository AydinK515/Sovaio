  ...
  return (
    <div className="pointer-events-none fixed inset-0 z-40">
      ...
      <button
        ...
        className={`channel-ai-launcher pointer-events-auto absolute bottom-4 right-4 hidden h-14 items-center justify-center gap-2 rounded-full bg-primary px-5 text-white shadow-lg transition-all duration-300 hover:bg-primary-hover lg:bottom-6 lg:right-6 lg:inline-flex ${
